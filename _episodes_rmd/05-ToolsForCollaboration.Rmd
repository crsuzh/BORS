---
source: Rmd
title: "Week 5 Tools for collaboration"
teaching: 0
exercises: 0
questions: 
  - "here are questions"
...
# 051-2-CERN: 1. Open Science at CERN
...
# 051-3-OSF: 2. The Open Science Framework as a collaborative tool
...
# 051-4-switchdrive: 3. SWITCHdrive and similar tools
...
# 051-5-versioncontrol: 4. What is version control?
...
2. Create a project for this course named `"<First name> <Last name>`´s course project"

3. In your project create a wiki and copy paste the course description from the course catalog in it, such that it shows when one enters the project.

4. Add Eva Furrer (eva.furrer@uzh.ch) as a collaborator in the project

5. Write a short paragraph about your reasons for joining this course in Markdown and add it to the project on OSF as a Markdown file and as a pdf.
...
You will upload your screenshot in the next step. Your submission will be peer reviewed as described above. Staff will perform random checks on the peer review.
