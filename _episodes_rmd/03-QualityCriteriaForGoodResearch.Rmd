...
> Below you find the checklist together with Why is this important? and Let’s dig deeper Sections. It can also be directly accessed in the [Markdown PRECHECK checklist]({{ page.root }}/files/docs/04/PRECHECKchecklist.md) (without the Why is this important? Sections).
>>**1. Research question**
>> 
...
>
>>## Question 1
Select two preprints in psychology and/or medicine. At least one of them should correspond to a preregistrqtion and one should have been published lateron. Review them using the checklist directly in the [Markdown file]({{ page.root }}/files/docs/04/PRECHECKchecklist.md). **Create one Markdown file for the assessment of both preprints by copy pasting**. Add clear sections for each preprint using Markdown syntax.
>>
