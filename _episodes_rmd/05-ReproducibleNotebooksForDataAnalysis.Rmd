...
### YAML header 
The YAML header of an R Markdown files contains the meta data that influence the final document in different ways. See the short summary from the [open-science-with-r carpentries course](https://carpentries-incubator.github.io/open-science-with-r/02-Rstudio/index.html):
...
The behavior of code chunks can be changed by setting **chunk options**. This is done in the opening of the chunk, e.g. 
