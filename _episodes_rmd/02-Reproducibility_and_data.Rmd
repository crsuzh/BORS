...
>
[trainingdata.xls]({{ page.root }}/_episodes_rmd/data/trainingdata.xls)
>
...
>
>We continue to work on the spreadsheet [trainingdata.xls]({{ page.root }}/_episodes_rmd/data/trainingdata.xls). This time we use `R` to correct the same errors in the spreadsheet. Why do you think is it better to use R for this process?
{: .challenge}
